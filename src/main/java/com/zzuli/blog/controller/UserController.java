...
public class UserController {
	...
	public ModelAndView list(@RequestParam(value = "async", required = false) boolean async,
		...
		List<User> list = userPage.getContent(); // 当前所在页面数据列表

		com.zzuli.blog.util.Page<User> page = new com.zzuli.blog.util.Page<User>(pageIndex, pageSize,
				(int) userPage.getTotalElements(), userPage.getContent());

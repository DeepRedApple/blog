...
public class EsBlogServiceImpl implements EsBlogService {
	...
	public List<TagVO> listTop30Tags() {
		...
		SearchQuery searchQuery = new NativeSearchQueryBuilder().withQuery(matchAllQuery())
				...
				.addAggregation(terms("tags.keyword").field("tags.keyword")
		...
		StringTerms modelTerms = (StringTerms) aggregations.asMap().get("tags.keyword");
	...
	public List<User> listTop12Users() {
		...
		SearchQuery searchQuery = new NativeSearchQueryBuilder().withQuery(matchAllQuery())
				.withSearchType(SearchType.QUERY_THEN_FETCH).withIndices("blog").withTypes("blog")
				.addAggregation(terms("users").field("username.keyword")
